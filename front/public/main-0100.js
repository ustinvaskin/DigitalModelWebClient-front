(function e(t, n, r) {
...
})(
  {
    ...
    2: [
      function (require, module, exports) {
        ...
        var App = {
          ...
          resizeArticleContent: function ($iframe) {
            var paddingTop =
              ($iframe.outerHeight() / $iframe.outerWidth()) * 100 || 56.25;
      ...
      {
        "./components/common/navbar": 3,
        "./components/common/polyfills": 4,
        "./components/common/popper": 5,
        "./components/common/search": 6,
      },
    ],
    3: [
      function (require, module, exports) {
        ...
        jQuery(document).ready(function ($) {
          search = function (domain, q) {
            ...
            if (wordpressIndicator) {
              ...
              window.location.href =
                "/" + jQuery("html").attr("lang") + "/?s=" + encodeURI(q);
            }
          };
