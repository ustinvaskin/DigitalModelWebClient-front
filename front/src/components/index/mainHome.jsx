...
function Main() {
  return (
    <div className="heroImage">
      ...
      <div className="hero">
        <div className="hero__inner">
          <div className="container">
            <div className="row description-in-main">
              <h1 className="heading-main text-center">Актуальные данные</h1>
              <h3 className="subheading text-center">Санкт-Петербург</h3>
            ...
            <div className="row">
              <div className="stats">
                <a href="#" className="stat__link">
                  <div className="stat__wrapper">
                    <div className="stat">
                      <div className="stat__value counter">35</div>
                      <div className="stat__description">Наборов Данных</div>
                    </div>
                  </div>
                </a>
                ...
                <a href="#" className="stat__link">
                  <div className="stat__wrapper">
                    <div className="stat">
                      <div className="stat__value counter">2</div>
                      <div className="stat__description">
                ...
                <a href="#" className="stat__link">
                  <div className="stat__wrapper">
                    <div className="stat">
                      <div className="stat__value counter  has-text-weight-bold has-text-color-is-green-stats ">
                        0.4
                      </div>
                      <div className="stat__description  has-text-weight-bold">
            ...
            <div className="row">
              <div className="stats">
                <a href="#" className="stat__link">
                  <div className="stat__wrapper">
                    <div className="stat">
                      <div className="stat__value counter">32</div>
                      <div className="stat__description">
                ...
                <a href="#" className="stat__link">
                  <div className="stat__wrapper">
                    <div className="stat">
                      <div className="stat__value counter">10</div>
                      <div className="stat__description">
                ...
                <a href="#" className="stat__link">
                  <div className="stat__wrapper">
                    <div className="stat">
                      <div className="stat__value counter is-color-red-in-stata">
                        15
                      </div>
                      <div className="stat__description">
      ...
      <div className="row title is-category-main">
        <p>Данные</p>
      </div>
      <div className="categories">
        <div className="category__wrapper">
          <div className="category--box">
            <a className="category__link">
              <div className="category__link-content">
                ...
                <span className="category__name">Жилые дома </span>
              </div>
            </a>
          </div>
        </div>{" "}
        <div className="category__wrapper">
          <div className="category--box">
            <Link className="category__link" to="/eventsInterface">
              <div className="category__link-content">
                <span className="category__icon">
                  <svg
                    version="1.1"
                ...
                <span className="category__name">События и точки притяжения</span>
              </div>
            </Link>
          </div>
        </div>{" "}
        <div className="category__wrapper">
          <div className="category--box">
            <Link className="category__link" to="/dataInterface">
              <div className="category__link-content">
                <span className="category__icon">
                  <svg
                    version="1.1"
                ...
                <span className="category__name">Культура</span>
              </div>
            </Link>
          </div>
        </div>{" "}
        <div className="category__wrapper">
          <div className="category--box">
            <Link className="category__link" to="/transport">
              <div className="category__link-content">
                <span className="category__icon">
                  <svg
                    version="1.1"
                ...
                <span className="category__name">Транспортная нагрузка </span>
              </div>
            </Link>
          </div>
        </div>{" "}
          ...
          <div className="category--box">
            <Link className="category__link" to="/dataInterface">
              <div className="category__link-content">
                ...
                <span className="category__name">Образование</span>
              </div>
            </Link>
          </div>
        </div>{" "}
          ...
          <div className="category--box">
            <Link className="category__link" to="/dataInterface">
              <div className="category__link-content">
                ...
                <span className="category__name">Кварталы </span>
              </div>
            </Link>
          </div>
        </div>{" "}
          ...
          <div className="category--box">
            <Link className="category__link" to="/dataInterface">
              <div className="category__link-content">
                ...
                <span className="category__name">Здравоохранение</span>
              </div>
            </Link>
          </div>
        </div>{" "}
        <div className="category__wrapper">
          <div className="category--box">
            <Link className="category__link" to="/problemInterface">
              <div className="category__link-content">
                <span className="category__icon">
                  <svg
                    version="1.1"
                ...
                <span className="category__name"> Жалобы и обращения</span>
              </div>
            </Link>
          </div>
        </div>{" "}
        <div className="category__wrapper">
          <div className="category--box">
            <Link className="category__link" to="/population">
              <div className="category__link-content">
                <span className="category__icon">
                  <svg
                    version="1.1"
                ...
                <span className="category__name">Население</span>
              </div>
            </Link>
          </div>
        </div>{" "}
        <div className="category__wrapper">
          <div className="category--box">
            <Link className="category__link" to="/ecology">
              <div className="category__link-content">
                <span className="category__icon">
                  <svg
                    version="1.1"
                ...
                <span className="category__name">Зеленые зоны </span>
              </div>
            </Link>
          </div>
        </div>{" "}
