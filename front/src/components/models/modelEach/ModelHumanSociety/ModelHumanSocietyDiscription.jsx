            ...
            <div class="col-md-9 col-sm-12 col-xs-12 news-content">
              ...
              <div>
                ...
                <div class="card-content">
                  <div class="content">
                    <p>
                      Модель представляет оценку ожидаемой лояльности горожан к
                      решениям развития города с точки зрения уровня обеспечения
                      жизни горожан всех групп и жизненных ситуаций. <p />
                      Модель предназначена для управления процессом внедрения
                      решений умного города и реализует концепцию умного города
                      НЦКР. В основе модели заложена ценностно-ориентированная
                      оценка качества жизни в умном городе, основанная на
                      представлении структуры ценностей и мотиваций всех групп
                      города в различных жизненных ситуациях.{" "}
                    </p>
                    <p>
                      Лояльность основана на выявлении потребности социальных
                      групп в целом и на отдельных территориях в обеспечении
                      сервисами и функциями города в каждой жизненной ситуации.
                    </p>
                    <p>
                      Такой подход позволяет определить обеспеченность и дефицит
                      сервисов применительно к конкретным жизненным ситуациям,
                      выявить необеспеченные группы населения, и оценить
                      потребности в сервисах умного города с точки зрения
                      текущей ситуации в городе.»{" "}
                    </p>
                  ...
                  <div className="btn-in-model-descr">
                    <Link to="/InterfaceHumanSociety">
                      <button class="button is-outlined is-danger is-m-5 is-longer-btn-loyal">
                        Демонстрация модели лояльности населения к умному городу
                      </button>
                    </Link>
                  </div>
                </div>
              ...
              <article class="panel is-info">
                ...
                <a class="panel-block is-active">
                  <span class="panel-icon"></span>
                  Коэффициенты модели ценностно-ориентированной оценки качества
