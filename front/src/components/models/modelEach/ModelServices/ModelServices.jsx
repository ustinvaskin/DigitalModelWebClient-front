            ...
            <div class="col-md-9 col-sm-12 col-xs-12 news-content">
                ...
                <div class="card-content">
                  <div class="content">
                    <p>
                      ...
                      городскими сервисами, функциями и инфраструктурой. Модель
                      учитывает доступность сервисов и функций для жителей
                      каждого жилого дома, а также потребности в горожан
                      сервисах и функциях в разных жизненных ситуациях
                    </p>
                  </div>
                </div>
              </div>
              ...
              <article class="panel is-info">
                ...
                <a
                  ...
                  href=" https://github.com/iduprojects/provision_model"
                  target="_blank"
                >
                ...
                <a
                  class="panel-block is-active"
                  href="http://77.234.203.187:17026/api/downloads/Описние_модели_обеспеченности_сервисами_и_функциями.pdf"
                >
                  <span class="panel-icon"></span>
                  Описание модели
                </a>
