...
class TableSocial extends React.Component {
  ...
  render() {
    ...
    return (
          ...
          <AccordionPanel>
            {this.state.dataGraph.map((data, id) => (
              <div className="container">
                ...
                <ul>
                  <li
                    className="list-item-table is-size-7 socilagropusli	 "
                    value={data.id}
                  >
      ...
      //       {this.state.dataGraph.map((data, id) => (
      //         <li
      //           className="list-item is-in-social-group-table is-size-7 has-text-weight-semibold	 "
      //           value={data.id}
      //         >
      //           {data.label}
      //         </li>
      ...
      //       {this.state.dataGraph.map((data, id) => (
      //         <li
      //           className="list-item is-in-social-group-table is-size-7 "
      //           value={data.id}
      //         >
      //           {data.value}
      //         </li>
      ...
      /* <table className="table">
          ...
          <tbody>
            <tr>
              {this.state.dataGraph.map((data, id) => (
                <th className="list-item" value={data.id}>
                  {data.label}
                </th>
              ))}
              ...
              <td></td>
              {this.state.dataGraph.map((data, id) => (
                <td className="list-item" value={data.id}>
                  {data.value}
                </td>
              ))}
              {this.state.dataGraph.map((data, id) => (
